    ...
    <div className='benefits-content'>
      {/* <div className='content-one'> */}
        <div className='mob-text'>
          ...
          <p className='blog-content-1'>Unlike most ovulation tests that only give you "yes/no" results, Inito provides real numerical values of your fertility hormones.</p>
          <p className='blog-content-1'> If you have irregular cycles, actual data is necessary to know exactly when you ovulate, and when is the best time to try to conceive.</p>
